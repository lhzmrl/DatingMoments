package org.vitamio.vitamiorecorderlibrary.view;
...
import org.vitamio.vitamiorecorderlibrary.R;
...
public class ProgressView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mMediaObject != null && mMediaObject.getMedaParts() != null) {
			...
			left = right = 0;
			Iterator<com.yixia.weibo.sdk.model.MediaObject$MediaPart> iterator = mMediaObject.getMedaParts().iterator();
			...
			while (hasNext) {
				com.yixia.weibo.sdk.model.MediaObject$MediaPart vp = iterator.next();
